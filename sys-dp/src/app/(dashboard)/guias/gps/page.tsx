...
export default async function GuiasGPSPage({
  searchParams,
}: {
  ...
  return (
    <>
      <Header title="GPS — Guia da Previdência Social" subtitle="INSS empregado e patronal" />
      <div className="flex-1 p-3 sm:p-6 space-y-6">

        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3">
          <Info className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
          <p className="text-sm text-blue-800">
            <strong>Vencimento GPS:</strong> Dia 20 do mês subsequente à competência (ou dia útil anterior, se dia não útil).
            Código de recolhimento: <strong>2100</strong> (empresa).
          </p>
        </div>
